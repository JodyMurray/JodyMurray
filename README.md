...
✓ I have a confident knowledge and familiarity with the following software tools: HTML, Python, Django, Flask, SQL, PostgreSQL, JavaScript, React, jQuery, kaboom.js, Jest, CSS, Materialize CSS, Tailwind, WordPress, Render, Heroku, Git, Cloudinary, ElephantSQL, Agile Methodologies.
