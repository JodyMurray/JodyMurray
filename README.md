...
✓ I have a confident knowledge and familiarity with the following software tools: HTML, CSS + Bootstrap, JavaScript + React.js, Python + Django (REST) Framework and Flask, and familiarity with PostgreSQL.
